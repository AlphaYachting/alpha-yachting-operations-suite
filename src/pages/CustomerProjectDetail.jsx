...
import { ArrowLeft, Clock, CheckCircle2, Pause, Calendar, MessageSquare, Image as ImageIcon, Ship } from 'lucide-react';
...
export default function CustomerProjectDetail() {
  ...
  const loadData = async () => {
    try {
      ...
      if (jobData.length > 0) {
        ...
        // Load customer-visible photos and comments
        const allPhotos = [];
        const allComments = [];
        ...
        // Build timeline from photos and comments
        const timelineItems = [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-cyan-50 p-6">
      <div className="max-w-6xl mx-auto">
        {/* Back Button */}
        <Link to={createPageUrl('CustomerBoatDetail') + `?boatId=${boat?.id}`}>
