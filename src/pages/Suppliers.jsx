...
export default function Suppliers() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Add Supplier Dialog */}
      <Dialog open={dialogOpen} onOpenChange={(open) => { setDialogOpen(open); if (!open) { setShowAIParser(false); setAiPrefillData(null); } }}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>Add New Supplier</DialogTitle>
          </DialogHeader>

          {/* AI Parser Panel - shown above form when active */}
          {showAIParser && !aiPrefillData && (
            <SupplierAIParser
          ...
          {!showAIParser && !aiPrefillData && (
            ...
            >
              ...
              Auto-fill from PDF or text
            </button>
          )}

          {/* AI pre-fill notice */}
          {aiPrefillData && (
            <div className="flex items-center justify-between px-3 py-2 bg-green-50 border border-green-200 rounded-lg mb-2 text-sm text-green-700">
              <span>✓ Form pre-filled by AI — review and save</span>
              <button
                onClick={() => setAiPrefillData(null)}
          ...
          <SupplierForm
            ...
            onCancel={() => { setDialogOpen(false); setShowAIParser(false); setAiPrefillData(null); }}
          />
        </DialogContent>
      </Dialog>
    </div>
