    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        ...
        filteredLeads.map((lead) => {
          const StatusIcon = statusIcons[lead.status]?.icon || Clock;
          const iconColor = statusIcons[lead.status]?.color || 'text-amber-500';
          const iconBg = statusIcons[lead.status]?.bg || 'bg-amber-50';
