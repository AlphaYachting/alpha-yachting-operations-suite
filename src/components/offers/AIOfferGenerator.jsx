          ...
          positions: {
            ...
            items: {
              ...
              properties: {
                ...
                unit_price_raw: { type: 'string', description: 'ORIGINAL unit price per piece BEFORE any discount and WITHOUT VAT. With multiple price columns take the retail/list unit price column: "MP cijena", "Listenpreis", "Einzelpreis", "Preis/Einheit", "Unit price" — NOT the wholesale column ("VP cijena"), NOT a percentage column (Rabat/PDV/MwSt), and NEVER a line amount ("MP iznos", "Betrag", "Gesamt") divided by quantity. Example row "6.00 | 24.00 | 25.00% | 30.00 | 15.00% | 153.00" → unit price is 30.00.' },
                total_price_raw: { type: 'string', description: 'Original line total = quantity × original unit price, before discount and without VAT. Leave empty if the document only shows a discounted amount.' },
                group: { type: 'string' },
