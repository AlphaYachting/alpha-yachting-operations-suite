...
export default function MobileHeaderWithWelcome({ user, taskCount, onSettingsClick, showSettings, onNavigate, workOrders, jobs, boats }) {
  ...
  return (
    <div className={`bg-gradient-to-br ${config?.styling?.backgroundColor || 'from-blue-600 via-blue-500 to-cyan-500'} text-white shadow-xl`}>
      ...
      {/* Search Bar */}
      <MobileSearchBar onNavigate={onNavigate} workOrders={workOrders} jobs={jobs} boats={boats} />
    </div>);
