...
import RepairOrderChatPage from './pages/RepairOrderChat';
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/RepairOrderChat" element={<LayoutWrapper currentPageName="RepairOrderChat"><RepairOrderChatPage /></LayoutWrapper>} />
